...
::\eqs::\eqarray(a\quad&b@c\quad&e){Enter}{Left 11}
...
::\pf::^bProof.^b{Enter 2}!={Space}{#}\qed{Enter}{Left 7}

::\thm::^bTheorem{Space}.^b^i{Space}{Left 2}

::\que::^bQuestion{Space}.^b{Space}{Left 2}
